...
public class ChipCustomMakeMgr : MonoBehaviour {

	private static ChipCustomMakeMgr m_Inst=null;

	private GameObject m_objMainUI;

	private List<ChipData> m_Chips;

	private ChipCustomMakeMgr()
	{
		m_objMainUI = null;
	...
	public static void InitInst()
	{
		if(m_Inst==null)
		{
			m_Inst = new ChipCustomMakeMgr ();
		}
	}

	public static ChipCustomMakeMgr GetInst()
	{
		return m_Inst;
	}
